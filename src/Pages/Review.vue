...
<template>
    <div class="container gray">
        ...
        <p class="subtitle">Оцени курс и поделись результатом, а также продолжи уход <a>новыми средствами</a> из нашей
            коллекции</p>

        <div class="stars">
            <button v-for="star in 5" :key="star" class="star-btn" @click="setRating(star)"
                @mouseenter="hoverRating = star" @mouseleave="hoverRating = 0">
                <svg :fill="getStarColor(star)" :stroke="getStarColor(star)" width="74" height="70" viewBox="0 0 74 70"
        ...
        <div class="review-input-wrapper">
            <textarea v-model="reviewText" class="review-textarea" placeholder="Оставить отзыв..." rows="4"></textarea>
        </div>
